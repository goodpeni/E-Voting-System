...
{
    public partial class MyVote : Form
    {
        public MyVote()
        {
            InitializeComponent();
        ...
        {
            MyVote.ActiveForm.BackgroundImage = Properties.Resources.lightmode;
        ...
        {
            MyVote.ActiveForm.BackgroundImage = Properties.Resources.darkmode;
            ...
            LblSideMyVote.BackColor = Color.LightSteelBlue;
